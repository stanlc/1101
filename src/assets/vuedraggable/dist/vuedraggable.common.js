...
// CONCATENATED MODULE: ./node_modules/_sortablejs@1.10.2@sortablejs/modular/sortable.esm.js
/**!
 * Sortable 1.10.2
...
const draggableComponent = {
  ...
  mounted() {
    ...
    const attributes = Object.keys(this.$attrs).reduce((res, key) => {
      res[Object(helper["a" /* camelize */])(key)] = this.$attrs[key];
      return res;
    }, {});
  ...
  methods: {
    ...
    updateOptions(newOptionValue) {
      for (var property in newOptionValue) {
        const value = Object(helper["a" /* camelize */])(property);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__("5243")))
